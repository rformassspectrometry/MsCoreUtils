...
```
    ...
    ## [29] "group"                      "group_mz_int"              
    ## [31] "i2index"                    "impute_bpca"               
    ## [33] "impute_fun"                 "impute_knn"                
    ## [35] "impute_matrix"              "impute_min"                
    ## [37] "impute_MinDet"              "impute_MinProb"            
    ## [39] "impute_mixed"               "impute_mle"                
    ## [41] "impute_neighbour_average"   "impute_QRILC"              
    ## [43] "impute_RF"                  "impute_with"               
    ## [45] "impute_zero"                "imputeMethods"             
    ## [47] "isPeaksMatrix"              "join"                      
    ## [49] "join_gnps"                  "join_gnps_r"               
    ## [51] "localMaxima"                "maxi"                      
    ## [53] "medianPolish"               "navdist"                   
    ## [55] "ndotproduct"                "nentropy"                  
    ## [57] "neuclidean"                 "noise"                     
    ## [59] "normalize_matrix"           "normalizeMethods"          
    ## [61] "nspectraangle"              "ppm"                       
    ## [63] "rbindFill"                  "reduce"                    
    ## [65] "refineCentroids"            "retry"                     
    ## [67] "rla"                        "robustSummary"             
    ## [69] "rowRla"                     "rt2character"              
    ## [71] "rt2numeric"                 "smooth"                    
    ## [73] "sumi"                       "validPeaksMatrix"          
    ## [75] "valleys"                    "vapply1c"                  
    ## [77] "vapply1d"                   "vapply1l"                  
    ## [79] "which.first"                "which.last"
...
## Session information
    ...
    ## [25] compiler_4.6.0      fs_2.1.0            htmlwidgets_1.6.4  
    ## [28] systemfonts_1.3.2   digest_0.6.39       R6_2.6.1           
    ## [31] bslib_0.10.0        tools_4.6.0         BiocGenerics_0.58.0
