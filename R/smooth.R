...
#' `(i - hws):(i + hws)`.
#'
#' @return A `matrix` with coefficients for a simple moving average.
#' @export
coefMA <- function(hws) {
    w <- 2L * hws + 1L
...
#'
#' @return A `matrix` with coefficients for a weighted moving average.
#' @export
...
#' peak shape.
#'
#' @return A `matrix` with *Savitzky-Golay-Filter* coefficients.
#'
#' @references
